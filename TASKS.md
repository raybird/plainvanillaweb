...
建立一個功能完備的原生影像編輯實驗室，展示濾鏡、縮放與格式壓縮技術。

## 🛠 任務分解

- [x] **Phase 1: 服務強化 (ADR 0082)**
  - [x] 建立 `docs/decisions/0082-native-image-studio.md`。
  - [x] 更新 `lib/image-service.js` 支援多重濾鏡與 Blob 壓縮。
- [x] **Phase 2: 實驗室實作**
  - [x] 建立 `components/pages/lab/ImageStudioPage.js`。
  - [x] 註冊路由與預載。
- [x] **Phase 3: 文件與導覽同步**
  - [x] 建立 `docs/native-image-processing.md`。
  - [x] 建立 Docs/Lab 雙向連結。
  - [x] 更新 `ROADMAP.md`。
