...
export class CollabPage extends BaseComponent {
    ...
    connectedCallback() {
        ...
        this._onChange = (data) => {
            if (data.id === 'lab-note') this.state.collabNote = data.value;
        };
    ...
    render() {
        return html`
            <div class="lab-card">
                ...
                <textarea rows="5" oninput="this.closest('page-lab-collab').handleCollabInput(this.value)">${this.state.collabNote}</textarea>
            </div>
